...
push @mirrors, 'https://deb.sipwise.com/debian/pool/main/m/mklibs';
push @mirrors, 'https://mirrors.edge.kernel.org/pub/linux/kernel/v3.x';
push @mirrors, 'https://cdn.kernel.org/pub/linux/utils/util-linux/v2.21';
push @mirrors, 'https://ftp.osuosl.org/pub/blfs/conglomeration/fuse';
push @mirrors, 'http://ftp.iij.ad.jp/pub/linux/kernel/software/network/iw';
