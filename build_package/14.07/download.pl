...
# for thc-ipv6-2.0.tar.gz
push @mirrors, 'http://raw.githubusercontent.com/vanhauser-thc/THC-Archive/master/Tools';
# for dosfstools_3.0.7.orig.tar.gz
push @mirrors, 'http://ftp.igh.cnrs.fr/pub/ubuntu-archive/ubuntu/ubuntu/pool/main/d/dosfstools';
# for fuse 2.9.0
push @mirrors, 'http://ftp.osuosl.org/pub/blfs/conglomeration/fuse';
