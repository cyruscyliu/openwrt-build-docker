...
# config part
#
DOWNLOAD_URL="https://github.com/openwrt/openwrt/archive/v19.07.0-rc2.tar.gz"
PACKAGE_NAME="v19.07.0-rc2.tar.gz"
PACKAGE_DIR_NAME="openwrt-19.07.0-rc2"
CACHE_DL_TAR="19.07.0-rc2.dl.tar.gz"
