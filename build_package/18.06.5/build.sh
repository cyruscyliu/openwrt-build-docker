...
# config part
#
DOWNLOAD_URL="https://github.com/openwrt/openwrt/archive/v18.06.5.tar.gz"
PACKAGE_NAME="v18.06.5.tar.gz"
PACKAGE_DIR_NAME="openwrt-18.06.5"
CACHE_DL_TAR="18.06.5.dl.tar.gz"
