...
# config part
#
DOWNLOAD_URL="https://github.com/openwrt/archive/archive/v15.05.1.tar.gz"
PACKAGE_NAME="v15.05.1.tar.gz"
PACKAGE_DIR_NAME="archive-15.05.1"
CACHE_DL_TAR="15.05.1.dl.tar.gz"
