...
# config part
#
DOWNLOAD_URL="https://github.com/openwrt/openwrt/archive/v18.06.0-rc2.tar.gz"
PACKAGE_NAME="v18.06.0-rc2.tar.gz"
PACKAGE_DIR_NAME="openwrt-18.06.0-rc2"
CACHE_DL_TAR="18.06.0-rc2.dl.tar.gz"
GIT_URL="https://github.com/openwrt/openwrt.git"
GIT_TAG="tags/v18.06.0-rc2"
