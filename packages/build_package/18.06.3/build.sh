...
# config part
#
DOWNLOAD_URL="https://github.com/openwrt/openwrt/archive/v18.06.3.tar.gz"
PACKAGE_NAME="v18.06.3.tar.gz"
PACKAGE_DIR_NAME="openwrt-18.06.3"
CACHE_DL_TAR="18.06.3.dl.tar.gz"
