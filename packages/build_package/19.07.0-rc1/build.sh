...
# config part
#
DOWNLOAD_URL="https://github.com/openwrt/openwrt/archive/v19.07.0-rc1.tar.gz"
PACKAGE_NAME="v19.07.0-rc1.tar.gz"
PACKAGE_DIR_NAME="openwrt-19.07.0-rc1"
CACHE_DL_TAR="19.07.0-rc1.dl.tar.gz"
...
touch ../BUILD_ERROR
make oldconfig && make -j${NPROC} V=s >buildout.txt 2>&1
ERR=$?
if [ "${ERR}" -ne 0 ]
then
