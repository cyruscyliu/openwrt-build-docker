...
# config part
#
DOWNLOAD_URL="https://github.com/openwrt/openwrt/archive/v17.01.2.tar.gz"
PACKAGE_NAME="v17.01.2.tar.gz"
PACKAGE_DIR_NAME="openwrt-17.01.2"
CACHE_DL_TAR="17.01.2.dl.tar.gz"
